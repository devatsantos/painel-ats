                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-200">
                                        ...
                                        <div key={pIndex} className="bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6 relative group">
                                            ...
                                            <div className="mb-6 pr-12">
                                                ...
                                                <input 
                                                    ...
                                                    required
                                                    className="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#080073]/20 focus:border-[#080073] transition-shadow"
                                            ...
                                            <div className="space-y-3">
                                                    ...
                                                    <div key={aIndex} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-white p-3 rounded-lg border border-gray-200">
                                                        <label className="flex items-center gap-2 min-w-max cursor-pointer">
                                                            <input 
                                                                ...
                                                                className="w-4 h-4 text-[#080073] focus:ring-[#080073] cursor-pointer"
                                                            />
                                                        ...
                                                        <input 
                                                            ...
                                                            required
                                                            className="flex-1 bg-gray-50 border border-gray-200 rounded-md px-3 py-2 text-sm focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#080073]/20 focus:border-[#080073] transition-colors"
                                                ...
                                                <button 
                                                    ...
                                                    className="mt-3 text-xs font-semibold text-[#080073] hover:text-blue-900 inline-flex items-center gap-1"
                                                >
                        ...
                        <div className="px-6 md:px-8 py-5 bg-gray-50 border-t border-gray-200 rounded-b-2xl flex items-center justify-end gap-4">
                            ...
                            <button 
                                type="submit" 
                                disabled={processing}
                                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#080073] hover:bg-[#0a0090] disabled:opacity-50 transition-all shadow-md"
                            >
                                {processing ? (
                                    <>
