                    ...
                    <header className="mb-8">
                        <div className="flex justify-between items-start">
                            ...
                            <button
                                ...
                                className="bg-[#080073] hover:bg-[#0a009e] text-white font-semibold py-2.5 px-5 rounded-xl shadow-sm transition-colors flex items-center gap-2"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                            <div>
                                ...
                                <h3 className="text-4xl font-bold text-[#080073]">{talentos.total}</h3>
                            </div>
                                ...
                                <div className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-sm text-[#080073] font-semibold mt-0.5">{talento.nivel_escolaridade}</p>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                {loadingSlots ? (
                                    ...
                                    <select
                                        ...
                                        className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-[#080073] focus:ring-2 focus:ring-[#080073]/20 transition disabled:opacity-50"
                                    >
                                ...
                                <div className="flex gap-3">
                                    {['Presencial', 'Online'].map(t => (
                                        <label key={t} className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border cursor-pointer text-sm font-medium transition ${
                                            entrevista.tipo === t
                                                ? 'border-[#080073] bg-[#080073]/5 text-[#080073]'
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-[#080073]/10 file:text-[#080073] hover:file:bg-[#080073]/20 file:cursor-pointer file:transition-colors"
                                            required={!editMode}
                                        />
                                        {editMode && (
                        ...
                        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3 rounded-b-2xl shrink-0">
                            ...
                            <button
                                ...
                                form="form-talento"
                                disabled={processing}
                                className="text-sm font-semibold text-white bg-[#080073] hover:bg-[#0a009e] px-5 py-2.5 rounded-xl transition-colors cursor-pointer disabled:opacity-50"
                            >
