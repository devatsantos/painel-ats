                ...
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        ...
                        <div className="flex gap-2">
                            <a href="/vagas?modal=true" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#071F30] text-white text-sm font-semibold hover:bg-[#007EAE] transition-colors shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold text-[#071F30]">{totalEntrevistasMes}</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="flex items-center justify-between px-6 pt-6 pb-4">
                                ...
                                <a href="/entrevistas" className="text-xs font-semibold text-[#071F30] bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition-colors">
                                    Ver todas
                                </a>
                            </div>
                            {proximasEntrevistas && proximasEntrevistas.length > 0 ? (
                                <div className="px-6 pb-6 space-y-3">
                                    {proximasEntrevistas.map((e, i) => {
                                        const accentBorder = e.tipo === 'online' ? 'border-l-purple-400' : e.tipo === 'hibrido' ? 'border-l-teal-400' : 'border-l-[#071F30]';
                                        return (
                                            <div key={i} className={`flex items-center gap-4 p-4 rounded-xl border border-gray-100 border-l-4 ${accentBorder} bg-gray-50/50 hover:bg-gray-50 transition-colors`}>
                                                {/* Avatar */}
                                                <div className="w-10 h-10 rounded-full bg-[#071F30]/10 flex items-center justify-center shrink-0 text-[#071F30] font-bold text-sm">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col">
                            <div className="flex items-center justify-between mb-5">
                                ...
                                <a href="/vagas" className="text-xs font-semibold text-[#071F30] hover:underline">Ver todas</a>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                {atividadesRecentes && atividadesRecentes.length > 0 ? atividadesRecentes.map((atividade, index) => (
                                    <div key={index} className="flex gap-4">
                                        <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center shrink-0">
                                            <svg className="w-5 h-5 text-[#071F30]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                        </div>
                                        <div className="flex-1">
                                            <p className="text-sm text-gray-700">
                                                ...
                                                {atividade.vaga && (
                                                    <> para a vaga de <span className="font-bold text-[#071F30]">{atividade.vaga}</span></>
                                                )}.
                                            </p>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
                            <h2 className="text-base font-bold text-gray-900 border-l-4 border-[#071F30] pl-3 mb-5">Resumo do Recrutamento</h2>
                        ...
                        {aguardandoEntrevista.length === 0 ? (
                            ...
                            <div key={index} className="flex items-start gap-4 bg-gray-50 rounded-xl p-4 border border-gray-100">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-[#071F30] font-medium mt-0.5 truncate">{item.vaga}</p>
