...
export default function Create() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#080073]/10 via-slate-50 to-[#080073]/5 flex items-center justify-center p-4 sm:p-6 font-sans">
            ...
            <div className="w-full max-w-2xl bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-white/40 overflow-hidden transition-all duration-300">
                ...
                {/* Header */}
                <div className="bg-[#080073] px-6 py-10 sm:px-10 text-center relative overflow-hidden">
                    ...
                    {enviadoComSucesso ? (
                        <div className="text-center py-8 space-y-4 animate-fade-in">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center px-6 py-2.5 bg-[#080073] hover:bg-[#0a0090] text-white font-semibold rounded-xl text-sm transition-all duration-200 shadow-md cursor-pointer mt-4"
                            >
                                Enviar outro relato
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#080073] focus:ring-2 focus:ring-[#080073]/20 transition"
                                    />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#080073] focus:ring-2 focus:ring-[#080073]/20 transition resize-y"
                                    required
                                />
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-2xl hover:border-[#080073]/40 hover:bg-[#080073]/5 transition duration-150 cursor-pointer relative">
                                    <input
                                        type="file"
                                        accept="image/*"
                                    ...
                                    <div className="space-y-1 text-center pointer-events-none">
                                        ...
                                        <div className="flex text-sm text-gray-600 justify-center">
                                            <span className="relative rounded-md font-semibold text-[#080073] hover:underline focus-within:outline-none">
                                                Escolher arquivo
                                            </span>
                                        </div>
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full inline-flex justify-center items-center gap-2 py-3 px-6 text-sm font-semibold rounded-xl text-white bg-[#080073] hover:bg-[#0a0090] transition-colors disabled:opacity-50 cursor-pointer shadow-md font-mono mt-4"
                            >
                                {processing ? (
                                    <>
